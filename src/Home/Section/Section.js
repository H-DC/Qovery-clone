...
function Section() {
            ...
            (entries) => {
                ...
                images.forEach((img, i) => {
                    entries[0].intersectionRatio > 0 &&
                        (img.style.animation = `pop 1s ease ${i * 250}ms`);
                });
            },
            { threshold: 0.9 }
        );
    ...
    return (
        <div id="sectionContainer">
            ...
            <p>
                Qovery Engine is an open-source abstraction layer product that
                turns easy apps deployment on AWS, GCP, Azure and others Cloud
                providers. The Qovery Engine is coded in Rust and takes
                advantage of Terraform, Helm, Kubectl, Docker to manage
                resources.
            </p>
